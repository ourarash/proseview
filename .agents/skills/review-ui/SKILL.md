...
Act as a senior product designer and UX auditor with a high bar. Run Proseview
...
This is a review-only skill. Do not edit Proseview, its tests, or its E2E
...
- Read [references/workflows.md](references/workflows.md) for
...
3. Discover and read current product/contributor docs, roadmap or accepted
   ...
   not contracts.
4. Derive product intent from the repository: Proseview is a local desktop
...
1. Use the isolated repository, real Proseview server, fake agent/process
...
- A real Proseview server and browser session ran through the existing harness.
