...
where: The shore
when: Afternoon
goal: Alice wants to hear the sorrow
conflict: The Mock Turtle has no sorrow, only a school timetable
outcome: The lessons lessen each day, which is why they are called lessons
day: 30
pov: Alice
characters:
  - Alice
