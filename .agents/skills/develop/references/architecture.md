# Proseview Product and Architecture Invariants
...
- Proseview is a local, Markdown-first writing dashboard and agent harness. Keep
...
4. Alternatives rejected and the Proseview-specific cost of each.
