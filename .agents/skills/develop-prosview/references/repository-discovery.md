# Prosview Repository Discovery

Build a current repository profile before implementing, reviewing, or auditing.
The profile keeps the skills Prosview-specific without freezing today's paths,
...
5. The stable Prosview invariants in `prosview-architecture.md`.
...
| Discovered surface | Lanes that normally activate | Prosview-specific probes |
|---|---|---|
