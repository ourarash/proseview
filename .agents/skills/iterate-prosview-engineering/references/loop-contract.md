...
- the `$review-prosview-code` path and required review range.
...
- [ ] The objective/non-goals stayed immutable except for explicit user-approved
      amendments.
- [ ] Every implementation/remediation followed `$develop-prosview`, including
...
- [ ] Every review followed `$review-prosview-code`, was read-only, and reported
